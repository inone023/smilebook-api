...
### 관리자 전용 기능
1. **도서 등록 기능**  
2. **도서 수정 기능:** 도서 위치 및 기본정보 수정  
3. **회원 관리 기능:** 회원에게 경고 부여 및 이용정지 처리  

### IoT를 이용한 시스템
1. **RFID를 이용한 탭 방식의 대출 및 반납 시스템**  
2. **RFID를 이용한 도서 위치 추적**  
3. **RFID와 PIR(모션 센서)을 이용한 도난 방지 시스템**  
4. **LED 색상으로 도서 대출·반납 성공 여부 표시**
