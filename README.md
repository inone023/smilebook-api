...
>
> 🤖 **AI 활용:**  
> 프로젝트 전 과정에서 ChatGPT를 보조 도구로 활용하여  
> Spring Security 구조 분석, 예외 처리 로직 검증, AWS 배포 환경 설정 등  
> 구현 효율성과 처음 사용하는 기술들의 학습 속도를 향상시킴.  
>
> 👥 **팀 구성:**  
...
>
> 💡 **담당 역할:**  
> • 팀장으로서 프로젝트 일정 관리, 역할 분담, 보고서 작성 및 발표, 디자인 컨펌 수행  
> • AWS EC2·RDS 서버 구축 및 환경 설정  
> • Spring Boot 기반 REST API 구현 (회원·도서·대여·RFID 연동)  
> • Arduino RC522 RFID 회로 재배치 및 통신 안정화, 제어 로직 개발  
> • Android Retrofit 통신 및 로직 일부 개발  
> • 주요 기능 구현:  
>   - 회원가입 및 로그인  
>   - 도서 위치 조회  
>   - 내 정보 조회 및 수정  
>   - 관리자 모드 전환  
>   - 도서 예약  
>   - FCM을 이용한 대출·반납·이용 정지·경고 알림  
>   - 회원 이용정지 및 경고 기능  
> • Amazon RDS(MySQL) 데이터베이스 설계 및 JPA Entity 매핑  
>   - `member`, `admin`, `book_category` 엔티티 설계 및 자동 테이블 생성  
